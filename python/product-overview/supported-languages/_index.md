...
With handwritten recognition model [installed](/ocr/python-net/installation/), Aspose.OCR for Python via .NET can [extract](/ocr/python-net/recognition/read-handwritten-text/) text from handwritten notes in a number of languages based on [Extended Latin alphabet](/ocr/python-net/supported-characters/#handwritten-characters):
